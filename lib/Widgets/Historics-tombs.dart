...
class HistoricsTombs extends StatefulWidget {
  @override
  _HistoricsTombsState createState() => _HistoricsTombsState();
}

class _HistoricsTombsState extends State<HistoricsTombs> {
  @override

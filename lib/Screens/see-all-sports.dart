...
class SeeAllSports extends StatefulWidget {
  @override
  _SeeAllSportsState createState() => _SeeAllSportsState();
}

class _SeeAllSportsState extends State<SeeAllSports> {
  @override
  void initState() {
    super.initState();
  }
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        Container(
                          ...
                          width: 300,
                          child: Text(
                            'Retrouvez ceux qui ont marqué le monde du sport',

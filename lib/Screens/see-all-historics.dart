import 'package:catch_my_tomb/Fire-sevices.dart/FS-Historic.dart';
...
class SeeAllHistorics extends StatefulWidget {
  @override
  _SeeAllHistoricsState createState() => _SeeAllHistoricsState();
}

class _SeeAllHistoricsState extends State<SeeAllHistorics> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: SingleChildScrollView(
          child: StreamBuilder(
            stream: FirestoreServiceHistorics().getNotes(),
            builder:
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        Container(
                          ...
                          width: 300,
                          child: Text(
                            "Retrouvez ceux qui ont marqué l'histoire de notre monde",

import 'package:catch_my_tomb/Fire-sevices.dart/FS-Politics.dart';
...
class SeeAllPolitics extends StatefulWidget {
  @override
  _SeeAllPoliticsState createState() => _SeeAllPoliticsState();
}

class _SeeAllPoliticsState extends State<SeeAllPolitics> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: SingleChildScrollView(
          child: StreamBuilder(
            stream: FirestoreServicePolitics().getNotes(),
            builder:

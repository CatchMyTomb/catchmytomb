...
class SeeAllActors extends StatefulWidget {
  @override
  _SeeAllActorsState createState() => _SeeAllActorsState();
}

class _SeeAllActorsState extends State<SeeAllActors> {
  @override
  void initState() {
    super.initState();
  }
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        Container(
                          ...
                          width: 300,
                          child: Text(
                            'Retrouvez ceux qui ont marqué le monde du cinéma',
